...
!function(o,e,a){o("#menu").click(function(){o("body").addClass("push-menu-to-left"),o("#sidebar").addClass("open"),o(".overlay").addClass("show")}),o("#mask").click(function(){o("body").removeClass("push-menu-to-left"),o("#sidebar").removeClass("open"),o(".overlay").removeClass("show")}),o(e).scroll(function(){0<o(this).scrollTop()?o("body").addClass("light"):o("body").removeClass("light")});var s=o(".modal .close");s.on("click",function(){s.parent().parent().addClass("closed")});var l=o(".modal.exit");l.length&&ouibounce(l[0],{aggressive:!0,callback:function(){l.find(".close").on("click",function(){l.hide()})}});var c={close:o(".icon-remove-sign"),searchform:o(".search-form"),canvas:o("body"),dothis:o(".dosearch")};function n(){o(".search-wrapper").toggleClass("active"),c.searchform.toggleClass("active"),c.canvas.removeClass("search-overlay")}c.dothis.on("click",function(){o(".search-wrapper").toggleClass("active"),c.searchform.toggleClass("active"),c.searchform.find("input").focus(),c.canvas.toggleClass("search-overlay"),o(".search-field").simpleJekyllSearch()}),c.close.on("click",n),document.addEventListener("keyup",function(e){27==e.keyCode&&o(".search-overlay").length&&n()}),1<=document.getElementsByClassName("home").length&&new AnimOnScroll(document.getElementById("grid"),{minDuration:.4,maxDuration:.7,viewportFactor:.2}),smoothScroll.init({selectorHeader:".bar-header",speed:500,updateURL:!1})}(Zepto,window);
